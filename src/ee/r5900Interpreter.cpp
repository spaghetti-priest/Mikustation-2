...
static void
ee_decode_and_execute (R5900_Core *ee, u32 instruction)
{
...
*/
      case INSTR_SPECIAL:
      {
         ...
         switch(special)
         {
            ...
            {
               u32 sa                      = instr.sa;
               ee->reg.r[instr.rd].SD[0]   = (u64)((s32)ee->reg.r[instr.rt].UW[0] << sa);
...
r5900_cycle(R5900_Core *ee)
{
   ...
   ee_decode_and_execute(ee, ee->current_instruction);
