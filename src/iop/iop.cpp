...
static inline void
iop_branch (bool is_branching, u32 offset)
{
   if (is_branching) {
      iop.is_branching = true;
...
static void
iop_decode_and_execute (u32 instruction)
{
